...
from typing import List, Set, Union, Dict, Tuple, Optional, Iterable
...
class MudText(text.Text):
    ...
    # Copied over from Text and edited to use MudStyle.
    def render(self, console: "Console", end: str = "") -> Iterable["Segment"]:
        ...
        if not self._spans:
            ...
            if end:
                yield _Segment(end)
            return
        get_style = partial(console.get_style, default=MudStyle.null())
        ...
        style_cache: Dict[Tuple[MudStyle, ...], MudStyle] = {}
        style_cache_get = style_cache.get
        combine = MudStyle.combine

        def get_current_style() -> MudStyle:
